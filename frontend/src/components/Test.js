...
// // }
import React from 'react';
import { useGlobalContext } from '../Context/metaContext'; // Replace with correct path
...
function ChildComponent() {
  ...
  const handleUpdate = () => {
    ...
    setContextValue('New Value from ChildComponent');
  };

  return (
    <div>
      <p>Global Value: {contextValue}</p>
      <button onClick={handleUpdate}>Update Global Value</button>
    </div>
  );
}
